...
class MyAstroidChecker(BaseChecker):
    ...
    msgs = {
        ...
        "E9001": ("Napoleon error", "napoleon-rst-error", "help help help")
    }
    ...
    def visit_functiondef(self, node):
        start_lineno = node.blockstart_tolineno

    def visit_classdef(self, node):
        start_lineno = node.blockstart_tolineno

    # TODO: the above will run, and this will get the line number to the start
    # of the docstring.  But how do I attach pylint warnings to the line number
    # of the RST error?
